...
FROM spends
INNER JOIN expense_area ON spends.expense_area_id = expense_area.id
...
```sql
INSERT INTO spends
Values (343,7,18,16,'2021-04-01',38104091,'3780119655','Computer Hardware Dell',14);  //343 added for ID & 14 for amount as not specified
```
