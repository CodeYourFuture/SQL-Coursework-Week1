...
VALUES ('2021-04-21', 'Computer Hardware Dell', '38104091', '3780119655', '16', '7', '18')

ERROR:  null value in column "amount" violates not-null constraint
DETAIL:  Failing row contains (343, 7, 18, 16, 2021-04-21, 38104091, 3780119655, Computer Hardware Dell, null).
SQL state: 23502
```
...
```sql
SELECT TO_CHAR(date, 'MonthYYYY'), to_char(SUM(amount), 'L999,999,999')  FROM spends GROUP BY date;
```
