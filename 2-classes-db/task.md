...
FROM spends
inner join expense_areas on spends.expense_area_id = expense_areas.id
inner join esuppliers on spends.expense_area_id = expense_areas.id
WHERE expense_area = 'Better Hospital Food';
...
```sql
//answer
INSERT INTO spends (expense_type_id, expense_area_id,
date, transaction_no, supplier_inv_no,
description, amount)
VALUES ( 7, 18, '2021-04-01', 38104091, 3780119655, 'Computer Hardware Dell', 32000);
INSERT 0 1
