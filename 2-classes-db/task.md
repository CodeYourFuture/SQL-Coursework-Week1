...
`expense_areas` table:  
![](images/expense_areas.png)

`expense_types` table:  
![](images/expense_types.png)
...
```
    date    | supplier_id |            supplier             |         description         | amount
------------+-------------+---------------------------------+-----------------------------+--------
 2021-03-01 |          61 | WORCESTERSHIRE HOSPITAL SPC PLC | Meals Volume                | 100000
 2021-03-01 |          61 | WORCESTERSHIRE HOSPITAL SPC PLC | Meals Additional Variations |  32558
 2021-03-01 |          61 | WORCESTERSHIRE HOSPITAL SPC PLC | Meals Volume                | 105000
```
