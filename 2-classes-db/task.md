...
```sql
INSERT INTO spends (expense_type_id, expense_area_id, supplier_id, date, transaction_no, supplier_inv_no, description, amount) VALUES (17, 18, 16, '2021-04-01', 38104091, 3780119655, 'Computer Hardware Purch', 3000);
```
