...
Read more: https://javarevisited.blogspot.com/2012/11/how-to-join-three-tables-in-sql-query-mysql-sqlserver.html#ixzz7UiHJ9wxd
...
select supplier from suppliers where id =16;
        supplier        
------------------------
...
```sql
SELECT spends.date, sum(amount) AS Monthly_Spend 
FROM spends
WHERE
    date IN ('2021-03-01', '2021-04-01')
GROUP BY date;
