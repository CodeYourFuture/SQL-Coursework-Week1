...
```sql
SELECT date, supplier_id, expense_area_id, description, amount
FROM spends
...
```sql
INSERT INTO spends (date, expense_type_id, expense_area_id, supplier_id, description, transaction_no, supplier_inv_no, amount)
VALUES ('2021-04-01', 7, 18, 16, 'Computer Hardware Dell', '38104091', '3780119655', 32000);
...
```sql
SELECT TO_CHAR(date, 'Month YYYY') AS "Month", TO_CHAR(SUM(amount), '£999,999,999') AS "Monthly Spend"
FROM spends
WHERE date IN ('2021-03-01', '2021-04-01')
GROUP BY date;
```
