...
```sql
SELECT transaction_no, description, amount FROM spends WHERE amount>30000 AND amount<31000;
...
```sql
INSERT INTO spends (date, description, transaction_no, supplier_inv_no, supplier_id, expense_type_id, expense_area_id, amount) Values(To_Date('01/04/2021','DD/MM/YYYY'), 'Computer Hardware Dell',38104091,'3780119655', 16, 7,18, 32000);
```
