...
### 8. We have just received a late invoice for April! Add a new row to the spends table:
    ...
    for £32,000.
```sql
INSERT INTO spends (date, description,transaction_no, supplier_inv_no, expense_type_id, expense_area_id, amount,  supplier_id  )
VALUES ('2021-04-01', 'Computer Hardware Dell', 3810409, '3780119655', 7, 18, 32000, 16 );
