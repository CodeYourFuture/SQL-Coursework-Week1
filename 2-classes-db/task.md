...
where expense_area_id = (
    ...
    select date, supplier_id, description, amount 
    from expense_areas INNER JOIN spends ON expense_areas.id = spends.expense_area_id 
...
VALUES ('2021-03-01', 'Computer Hardware Dell', 38104091, '3780119655', 16, 7, 18, 32000); 
```
...
```sql ( Not respond to this properly need deeper research)
