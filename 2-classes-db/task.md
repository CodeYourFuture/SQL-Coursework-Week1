...
```sql
 SELECT date,transaction_no,description,amount FROM spends homework-> WHERE amount BETWEEN 30000 AND 31000;
```
...
```sql
    SELECT spends.date,spends.supplier_id,spends.description, spends.amount FROM spends
