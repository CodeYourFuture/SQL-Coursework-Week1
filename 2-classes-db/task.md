...
ERROR:  null value in column "amount" violates not-null constraint. Unable to process the query as the amount violates not-null restriction as we never specified a fixed amount for the amount column;
```
