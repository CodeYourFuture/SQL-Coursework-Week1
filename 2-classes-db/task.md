...
```sql
INSERT INTO spends (date,description,transaction_no,supplier_inv_no,supplier_id,expense_type_id, expense_area_id expense_area,amount) VALUES('2021-04-01', 'Computer Harware Dell',  38104091, '3780119655','COMPUTACENTER (UK) LTD', 'Computer Hardware Purch','ICT Contingency',  16, 7, 18,32000)
```
