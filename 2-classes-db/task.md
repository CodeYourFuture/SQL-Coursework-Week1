...
```sql
select date, transaction_no, supplier_inv_no, description, amount from spends where amount between 25000 and 35

select * from spends where amount = 250000 or amount = 30000 or amount = 35000 or amount = 40000;
```
