CREATE TABLE IF NOT EXISTS expense_types (id SERIAL PRIMARY KEY,
                                                            expense_type VARCHAR(30) NOT NULL);


CREATE TABLE IF NOT EXISTS expense_areas (id SERIAL PRIMARY KEY,
                                                            expense_area VARCHAR(30) NOT NULL);


CREATE TABLE IF NOT EXISTS suppliers (id SERIAL PRIMARY KEY,
                                                        supplier VARCHAR(60) NOT NULL);


CREATE TABLE IF NOT EXISTS spends (id SERIAL PRIMARY KEY,
